...
<%@ page import="com.gxuwz.dorm.bean.entity.SysAdmin" %>
...
<%
    ...
    //定义SQL语句
    String sql = "select * from sys_admin where userid=?";
    //创建执行动态SQL的对象
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="SysAdminServlet" target="_parent">  
